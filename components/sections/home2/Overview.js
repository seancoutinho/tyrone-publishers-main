                        ...
                        <div className="col-lg-6">
                            <div className="overview-content-two">
                                <div className="section-title-two mb-30 tg-heading-subheading animation-style1">
                                    <span className="sub-title tg-element-title">More About Us</span>
                                    <h2 className="title tg-element-title">We Make Sure To Understand Your Problem and Provide a Working Solution</h2>
                                </div>
                                <p></p>
                                <div className="progress-wrap">
                                    ...
                                    <div className="progress-item">
                                        <h6 className="title">Corporate Clothing</h6>
